...
public class EstadisticaFecha extends javax.swing.JFrame {
    ...
    private void UpdateTable(){
        ...
        try {
            ...
            cstmt =con.prepareCall("{?=call EstadisticaFecha(?,?)}");
            cstmt.setDate(2,Initialdate);
            cstmt.setDate(3, Finaldate);
    ...
    private void initComponents() {
        ...
        BT_Analizar.setBounds(270, 160, 90, 40);
        ...
        CB_Dia2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CB_Dia2ActionPerformed(evt);
            }
        });
        ...
        CB_Mes2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CB_Mes2ActionPerformed(evt);
            }
        });
        ...
        CB_Año2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CB_Año2ActionPerformed(evt);
            }
        });
    ...
    private void CB_Dia2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB_Dia2ActionPerformed
        // TODO add your handling code here:
        if(Integer.parseInt(CB_Dia2.getSelectedItem().toString())<
                Integer.parseInt(CB_Dia2.getSelectedItem().toString())){
           JOptionPane.showMessageDialog(this, "Dia Final no puede ser menor que Inicial",null,JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_CB_Dia2ActionPerformed

    private void CB_Mes2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB_Mes2ActionPerformed
        // TODO add your handling code here:
        if(Integer.parseInt(CB_Mes2.getSelectedItem().toString())<
                Integer.parseInt(CB_Mes2.getSelectedItem().toString())){
           JOptionPane.showMessageDialog(this, "Mes Final no puede ser menor que Inicial",null,JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_CB_Mes2ActionPerformed

    private void CB_Año2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CB_Año2ActionPerformed
        // TODO add your handling code here:
        if(Integer.parseInt(CB_Año2.getSelectedItem().toString())<
                Integer.parseInt(CB_Año2.getSelectedItem().toString())){
           JOptionPane.showMessageDialog(this, "Año Final no puede ser menor que Inicial",null,JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_CB_Año2ActionPerformed

 ...
 * @author Luis Diego
 */
public class RegistroNacionalidad extends javax.swing.JFrame {

    /**
     * Creates new form RegistroCurso
     */
    public RegistroNacionalidad() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Titulo_Registro_de_Puesto.setText("Registro de Nacionalidad");
        getContentPane().add(Titulo_Registro_de_Puesto);
        Titulo_Registro_de_Puesto.setBounds(90, 30, 230, 22);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistroNacionalidad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistroNacionalidad().setVisible(true);
            }
        });
    }
